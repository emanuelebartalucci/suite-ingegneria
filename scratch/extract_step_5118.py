...
out_path = r"C:\Users\e.bartalucci.INGEGNO.001\Documents\Antigravity\suite-ingegneria\scratch\step_5118.txt"
                ...
                for tc in tcs:
                    ...
                    if "ToolCalcoliVari.tsx" in target_file:
                        ...
                        with open(out_path, 'w', encoding='utf-8') as out:
                            out.write(repl)
                        print(f"Written step 5118 replacement content to {out_path}")
                        break
else:

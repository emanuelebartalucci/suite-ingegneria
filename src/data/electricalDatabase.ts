...
export const INITIAL_CABLES: CableProduct[] = [
  ...
  {
    id: 'fg16oh2r16',
    name: 'FG16OH2R16 0.6/1 kV Armato',
  ...
  {
    id: 'ftg18om16',
    name: 'FTG18OM16 0.6/1 kV Resistente Fuoco',
...
export const INITIAL_CONTAINERS: ContainerFamily[] = [
  {
    ...
    name: 'Canale metallico chiuso H75 PG',
    description: 'Passerella blindata zincata in continuo (Sendzimir) per installazione a vista, altezza 75mm.',
    type: 'contenitore',
  ...
  },
  {
    ...
    name: 'Canale metallico asolato H75 PG',
    description: 'Passerella asolata zincata Sendzimir per posa cavi a vista con dissipazione termica, altezza 75mm.',
    type: 'contenitore',
    sectionType: 'rettangolare',
    installationType: 'vista',
    sizes: [
  ...
  {
    id: 'canala_pvc',
    name: 'Canale portacavi in PVC Canalplast',
  ...
  {
    id: 'cavidotto',
    name: 'Cavidotto corrugato doppia parete',
  ...
  },
  {
    ...
    type: 'contenitore',
    sectionType: 'circolare',
    installationType: 'tazze', // trattato come tubo protettivo circolare
    sizes: [

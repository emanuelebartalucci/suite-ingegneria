...
export function ToolDispersione({ projectData, setProjectData, setAppMode, pipeCatalog }: ToolDispersioneProps) {
    ...
    return (
        <div className="max-w-6xl mx-auto animate-fade-in">
            ...
            <ProjectHeader pData={projectData} setPData={setProjectData} title="Dispersione Tubazioni" setAppMode={setAppMode} iconColor="redbrand" docCode="M_4.4.6_E4_Term_00" />
